...
// 环境变量
const UUID = process.env.UUID || 'a91f038d-3918-489f-a0aa-04f16627b7dc'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || '5c1bad07-0170-4ff2-a887-061d4177d09a.e1-eu-north-azure.choreoapps.dev';                   // 域名或ip,留空将自动获取服务器ip
